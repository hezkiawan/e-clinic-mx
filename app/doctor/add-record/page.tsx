...
import { Heart, User, FileText, Pill, StickyNote, AlertCircle, CheckCircle } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Add Medical Record</h1>
          <p className="text-slate-600">Complete the medical record for your patient consultation</p>
        </div>
